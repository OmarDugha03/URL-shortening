...
import { facebook, Insta, pinterest, twitter } from '@/Images/index'
...
const Footer: FC<FooterProps> = ({}) => {
  ...
  const resources = [{ id: 'Blog' }, { id: 'Developers' }, { id: 'Support' }]
  const company = [
    { id: ' About' },
    { id: ' Our Team' },
    { id: ' Careers ' },
  ...
  return (
    <div className='flex flex-col items-center justify-evenly bg-stone-900 pt-2 text-white lg:flex-row lg:items-start lg:py-8'>
      <svg
      ...
      <div className='flex flex-col items-center '>
        <h2 className='mx-4 py-2 text-lg font-black tracking-wider'>
          Features
        </h2>
        {features.map(i => (
          <div className='py-1 font-medium opacity-90 ' key={i.id}>
            {i.id}
          </div>
        ))}
      </div>
      ...
      <div className='flex flex-col items-center '>
        <h2 className='mx-4 py-2 text-lg font-black tracking-wider'>Company</h2>
        {company.map(i => (
          <div className='py-1 font-medium opacity-90 ' key={i.id}>
            {i.id}
          </div>
      ...
      <div className='flex items-center px-2 py-8'>
        <Image src={facebook} alt='Icons' className='mx-2' />
        <Image src={Insta} alt='Icons' className='mx-2' />
        <Image src={pinterest} alt='Icons' className='mx-2' />
        <Image src={twitter} alt='Icons' className='mx-2' />
      </div>
    </div>
  )
}
