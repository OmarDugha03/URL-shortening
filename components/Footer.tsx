...
const Footer: FC<FooterProps> = ({}) => {
  ...
  return (
    <div className="flex flex-col items-center pt-2 text-white lg:py-8 lg:items-start justify-evenly lg:flex-row bg-stone-900">
      <svg
      ...
      <div className="flex flex-col items-center ">
        <h2 className="py-2 mx-4 text-lg font-black tracking-wider">
          Features
        </h2>
        {features.map((i) => (
      ...
      <div className="flex flex-col items-center ">
        <h2 className="py-2 mx-4 text-lg font-black tracking-wider">Company</h2>
        {company.map((i) => (
          <div className="py-1 font-medium opacity-90 " key={i.id}>
            {i.id}
          </div>
